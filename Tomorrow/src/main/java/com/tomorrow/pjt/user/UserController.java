...
import com.tomorrow.pjt.ViewRef;
...
public class UserController 
{
	 ...
	 * 
	 * @ResponseBody public int ajaxToggleFavorite(UserPARAM param, HttpSession hs)
	 * { System.out.println("==> ajaxToggleFavorite"); int i_user =
	 * SecurityUtils.getLoginUserPk(hs); param.setI_user(i_user); return
	 * service.ajaxToggleFavorite(param); }
	 */
